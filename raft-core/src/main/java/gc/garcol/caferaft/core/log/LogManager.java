...
public class LogManager {
    ...
    public Position nextPosition(Position position) {
        ...
        if (position.index() < segmentSize - 1) {
            return new Position(position.term(), position.index() + 1);
        }
        ...
        return new Position(nextSegment.getTerm(), 0);
    }
    ...
    public Position previousPosition(Position position) {
        ...
        return new Position(previousSegment.getTerm(), previousSegmentSize - 1);
    }
