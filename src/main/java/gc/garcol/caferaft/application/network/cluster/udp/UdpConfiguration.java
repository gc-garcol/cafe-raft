...
public class UdpConfiguration {
    ...
    @Bean
    public UnicastReceivingChannelAdapter udpReceiverAdapter(
        final MessageChannel inboundChannel
    ) {
        UnicastReceivingChannelAdapter receiver = new UnicastReceivingChannelAdapter(ports.get(clusterProperty.getNodeId()));
