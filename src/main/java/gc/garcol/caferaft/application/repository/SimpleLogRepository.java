...
public class SimpleLogRepository implements LogRepository {
    ...
    public LogEntry appendLog(long term, Command command) {
        try (
            RandomAccessFile file = new RandomAccessFile(getDataFilePath(term), READ_WRITE_MODE);
            RandomAccessFile indexFile = new RandomAccessFile(getIndexFilePath(term), READ_WRITE_MODE)
        ) {
    ...
    private LogEntry appendLogInternal(RandomAccessFile file, RandomAccessFile indexFile, long term, Command command) throws IOException {
    ...
    public LogEntry getLog(long term, long index) {
        try (
            RandomAccessFile file = new RandomAccessFile(getDataFilePath(term), READ_MODE);
            RandomAccessFile indexFile = new RandomAccessFile(getIndexFilePath(term), READ_MODE)
        ) {
    ...
    private LogEntry getLogInternal(RandomAccessFile file, RandomAccessFile indexFile, long term, long index) throws IOException {
